 ...
 * @author Admin
 */
public class SignUpPageDummy extends javax.swing.JFrame {

    /**
     * Creates new form SignUpPageDummy
     */
    public SignUpPageDummy() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SignUpPageDummy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SignUpPageDummy().setVisible(true);
            }
        });
    }
